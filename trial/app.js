...
! function (t, e) {
    ...
    var a, o, l, h, u, f = function (t) {
        ...
        v = function (r, s, a, o) {
            ...
            this.check = function (h) {
                for (var u, p, _, c, d = s.length, m = d; --d > -1;)(u = g[s[d]] || new v(s[d], [])).gsClass ? (l[d] = u.gsClass, m--) : h && u.sc.push(this);
                if (0 === m && a) {
                    if (_ = (p = ("com.greensock." + r).split(".")).pop(), c = f(p.join("."))[_] = this.gsClass = a.apply(a, l), o)
                        if (n[_] = i[_] = c, "undefined" != typeof module && module.exports)
                            if (r === e)
                                for (d in module.exports = i[e] = c, i) c[d] = i[d];
                            else i[e] && (i[e][_] = c);
    ...
    var T = [0, 0, 1, 1],
        ...
        P = w.register = function (t, e, i, r) {
            for (var n, s, a, o, l = e.split(","), h = l.length, u = (i || "easeIn,easeOut,easeInOut").split(","); --h > -1;)
                for (s = l[h], n = r ? x("easing." + s, null, !0) : p.easing[s] || {}, a = u.length; --a > -1;) o = u[a], b[s + "." + o] = b[o + s] = n[o] = t.getRatio ? t : t[o] || new t
        };
    ...
    (l = O.prototype).addEventListener = function (t, e, i, r, n) {
        ...
        var s, a, o = this._listeners[t],
            l = 0;
        for (this !== h || u || h.wake(), null == o && (this._listeners[t] = o = []), a = o.length; --a > -1;)(s = o[a]).c === e && s.s === i ? o.splice(a, 1) : 0 === l && s.pr < n && (l = a + 1);
        o.splice(l, 0, {
            c: e,
            s: i,
            up: r,
    ...
    var S = t.requestAnimationFrame,
        ...
        A = C();
    for (o = (a = ["ms", "moz", "webkit", "o"]).length; --o > -1 && !S;) S = t[a[o] + "RequestAnimationFrame"], k = t[a[o] + "CancelAnimationFrame"] || t[a[o] + "CancelRequestAnimationFrame"];
    x("Ticker", function (t, e) {
        var i, n, s, a, o, l = this,
            ...
            g = function (t) {
                var e, r, h = C() - A;
                h > _ && (f += h - c), A += h, l.time = (A - f) / 1e3, e = l.time - o, (!i || e > 0 || !0 === t) && (l.frame++, o += e + (e >= a ? .004 : a - e), r = !0), !0 !== t && (s = n(g)), r && l.dispatchEvent(m)
            };
        O.call(l), l.time = l.frame = 0, l.tick = function () {
            g(!0)
        }, l.lagSmoothing = function (t, e) {
            return arguments.length ? (_ = t || 1e8, void(c = Math.min(e, _, 0))) : 1e8 > _
        }, l.sleep = function () {
            null != s && (p && k ? k(s) : clearTimeout(s), n = d, s = null, l === h && (u = !1))
        }, l.wake = function (t) {
            null !== s ? l.sleep() : t ? f += -A + (A = C()) : l.frame > 10 && (A = C() - _ + 5), n = 0 === i ? d : p && S ? S : function (t) {
    ...
    h = M.ticker = new p.Ticker, (l = M.prototype)._dirty = l._gc = l._initted = l._paused = !1, l._totalTime = l._time = 0, l._rawPrevTime = -1, l._next = l._last = l._onUpdate = l._timeline = l.timeline = null, l._paused = !1;
    var R = function () {
    ...
    R(), l.play = function (t, e) {
        ...
        return t != this._paused && r && (u || t || h.wake(), i = (e = r.rawTime()) - this._pauseTime, !t && r.smoothChildTiming && (this._startTime += i, this._uncache(!1)), this._pauseTime = t ? e : null, this._paused = t, this._active = this.isActive(), !t && 0 !== i && this._initted && this.duration() && (e = r.smoothChildTiming ? this._totalTime : (e - this._startTime) / this._timeScale, this.render(e, e === this._totalTime, !0))), this._gc && !t && this._enabled(!0, !1), this
    };
    var F = x("core.SimpleTimeline", function (t) {
        M.call(this, 0, t), this.autoRemoveChildren = this.smoothChildTiming = !0
    });
    (l = F.prototype = new M).constructor = F, l.kill()._gc = !1, l._first = l._last = l._recent = null, l._sortChildren = !1, l.add = l.insert = function (t, e, i, r) {
        var n, s;
    ...
    var D = x("TweenLite", function (e, i, r) {
            if (M.call(this, i, r), this.render = D.prototype.render, null == e) throw "Cannot tween a null target.";
            this.target = e = "string" != typeof e ? e : D.selector(e) || e;
            var n, s, a, o = e.jquery || e.length && e !== t && e[0] && (e[0] === t || e[0].nodeType && e[0].style && !e.nodeType),
                l = this.vars.overwrite;
            if (this._overwrite = l = null == l ? Q[D.defaultOverwrite] : "number" == typeof l ? l >> 0 : Q[l], (o || e instanceof Array || e.push && m(e)) && "number" != typeof e[0])
                for (this._targets = a = c(e), this._propLookup = [], this._siblings = [], n = 0; n < a.length; n++)(s = a[n]) ? "string" != typeof s ? s.length && s !== t && s[0] && (s[0] === t || s[0].nodeType && s[0].style && !s.nodeType) ? (a.splice(n--, 1), this._targets = a = a.concat(c(s))) : (this._siblings[n] = tt(s, this, !1), 1 === l && this._siblings[n].length > 1 && it(s, this, null, 1, this._siblings[n])) : "string" == typeof (s = a[n--] = D.selector(s)) && a.splice(n + 1, 1) : a.splice(n--, 1);
        ...
        z = function (t, e) {
            var i, r = {};
            for (i in t) Z[i] || i in e && "transform" !== i && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i || !(!q[i] || q[i] && q[i]._autoCSS) || (r[i] = t[i], delete t[i]);
            t.css = r
        };
    (l = D.prototype = new M).constructor = D, l.kill()._gc = !1, l.ratio = 0, l._firstPT = l._targets = l._overwrittenProps = l._startAt = null, l._notifyPluginsOfEnabled = l._lazy = !1, D.version = "2.1.3", D.defaultEase = l._ease = new w(null, null, 1, 1), D.defaultOverwrite = "auto", D.ticker = h, D.autoSleep = 120, D.lagSmoothing = function (t, e) {
        h.lagSmoothing(t, e)
    }, D.selector = t.$ || t.jQuery || function (e) {
        var i = t.$ || t.jQuery;
        return i ? (D.selector = i, i(e)) : (r || (r = t.document), r ? r.querySelectorAll ? r.querySelectorAll(e) : r.getElementById("#" === e.charAt(0) ? e.substr(1) : e) : e)
    };
    var I = [],
        E = {},
        L = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
        ...
        j = function (t, e, i, r) {
            var n, s, a, o, l, h, u, f = [],
                ...
                _ = "",
                c = 0;
            for (f.start = t, f.end = e, t = f[0] = t + "", e = f[1] = e + "", i && (i(f), t = f[0], e = f[1]), f.length = 0, n = t.match(L) || [], s = e.match(L) || [], r && (r._next = null, r.blob = 1, f._firstPT = f._applyPT = r), l = s.length, o = 0; l > o; o++) u = s[o], _ += (h = e.substr(p, e.indexOf(u, p) - p)) || !o ? h : ",", p += h.length, c ? c = (c + 1) % 5 : "rgba(" === h.substr(-5) && (c = 1), u === n[o] || n.length <= o ? _ += u : (_ && (f.push(_), _ = ""), a = parseFloat(n[o]), f.push(a), f._firstPT = {
                _next: f._firstPT,
                t: f,
                p: f.length - 1,
                s: a,
            ...
            return (_ += e.substr(p)) && f.push(_), f.setRatio = Y, N.test(e) && (f.end = null), f
        },
        V = function (t, e, i, r, n, s, a, o, l) {
            ...
            return ("number" != typeof p || "number" != typeof r && !_) && (a || isNaN(p) || !_ && isNaN(r) || "boolean" == typeof p || "boolean" == typeof r ? (c.fp = a, c = {
                ...
                pr: 0,
                m: 0
            }) : (c.s = parseFloat(p), _ || (c.c = parseFloat(r) - c.s || 0))), c.c ? ((c._next = this._firstPT) && (c._next._prev = c), this._firstPT = c, c) : void 0
        },
        U = D._internals = {
            isArray: m,
            isSelector: X,
        ...
        J = U.lazyRender = function () {
            var t, e, i = I.length;
            for (E = {}, t = 0; i > t; t++)(e = I[t]) && !1 !== e._lazy && (e.render(e._lazy[0], e._lazy[1], !0), e._lazy = !1);
            I.length = 0
        };
    $._startTime = h.time, H._startTime = h.frame, $._active = H._active = !0, setTimeout(J, 1), M._updateRoot = D.render = function () {
        var t, e, i;
        if (I.length && J(), $.render((h.time - $._startTime) * $._timeScale, !1, !1), H.render((h.frame - H._startTime) * H._timeScale, !1, !1), I.length && J(), h.frame >= K) {
            for (i in K = h.frame + (parseInt(D.autoSleep, 10) || 120), G) {
    ...
    var tt = function (t, e, i) {
        ...
        it = function (t, e, i, r, n) {
            ...
            var h, u = e._startTime + _,
                ...
                p = 0,
                c = 0 === e._duration;
            for (s = n.length; --s > -1;)(o = n[s]) === e || o._gc || o._paused || (o._timeline !== e._timeline ? (h = h || rt(e, 0, c), 0 === rt(o, h, c) && (f[p++] = o)) : o._startTime <= u && o._startTime + o.totalDuration() / o._timeScale > u && ((c || !o._initted) && u - o._startTime <= 2 * _ || (f[p++] = o)));
            for (s = p; --s > -1;)
    ...
    l._init = function () {
        ...
        if (a.startAt) {
            ...
            if (f) f.render(-1, !0), f.kill(), this._startAt = null;
                ...
                for (r in 0 !== this._time && (h = !1), i = {}, a) Z[r] && "autoCSS" !== r || (i[r] = a[r]);
            ...
            } if (this._ease = u = u ? u instanceof w ? u : "function" == typeof u ? new w(u, a.easeParams) : b[u] || D.defaultEase : D.defaultEase, a.easeParams instanceof Array && u.config && (this._ease = u.config.apply(u, a.easeParams)), this._easeType = this._ease._type, this._easePower = this._ease._power, this._firstPT = null, this._targets)
        ...
        var a, o, l, h, u, f;
        if (null == e) return !1;
        for (a in E[e._gsTweenID] && J(), this.vars.css || e.style && e !== t && e.nodeType && q.css && !1 !== this.vars.autoCSS && z(this.vars, e), this.vars)
            if (f = this.vars[a], Z[a]) f && (f instanceof Array || f.push && m(f)) && -1 !== f.join("").indexOf("{self}") && (this.vars[a] = f = this._swapSelfInParams(f, this));
        ...
        } else i[a] = V.call(this, e, a, "get", f, a, 0, null, this.vars.stringFilter, s);
        return n && this._kill(n, e) ? this._initProps(e, i, r, n, s) : this._overwrite > 1 && this._firstPT && r.length > 1 && it(e, this, i, this._overwrite, r) ? (this._kill(i, e), this._initProps(e, i, r, n, s)) : (this._firstPT && (!1 !== this.vars.lazy && this._duration || this.vars.lazy && !this._duration) && (E[e._gsTweenID] = !0), l)
    }, l.render = function (t, e, i) {
        var r, n, s, a, o = this,
            l = o._time,
            h = o._duration,
            u = o._rawPrevTime;
        if (t >= h - _ && t >= 0) o._totalTime = o._time = h, o.ratio = o._ease._calcEnd ? o._ease.getRatio(1) : 1, o._reversed || (r = !0, n = "onComplete", i = i || o._timeline.autoRemoveChildren), 0 === h && (o._initted || !o.vars.lazy || i) && (o._startTime === o._timeline._duration && (t = 0), (0 > u || 0 >= t && t >= -_ || u === _ && "isPause" !== o.data) && u !== t && (i = !0, u > _ && (n = "onReverseComplete")), o._rawPrevTime = a = !e || t || u === t ? t : _);
        else if (_ > t) o._totalTime = o._time = 0, o.ratio = o._ease._calcEnd ? o._ease.getRatio(0) : 0, (0 !== l || 0 === h && u > 0) && (n = "onReverseComplete", r = o._reversed), t > -_ ? t = 0 : 0 > t && (o._active = !1, 0 === h && (o._initted || !o.vars.lazy || i) && (u >= 0 && (u !== _ || "isPause" !== o.data) && (i = !0), o._rawPrevTime = a = !e || t || u === t ? t : _)), (!o._initted || o._startAt && o._startAt.progress()) && (i = !0);
        else if (o._totalTime = o._time = t, o._easeType) {
            var f = t / h,
                p = o._easeType,
                c = o._easePower;
            (1 === p || 3 === p && f >= .5) && (f = 1 - f), 3 === p && (f *= 2), 1 === c ? f *= f : 2 === c ? f *= f * f : 3 === c ? f *= f * f * f : 4 === c && (f *= f * f * f * f), o.ratio = 1 === p ? 1 - f : 2 === p ? f : .5 > t / h ? f / 2 : 1 - f / 2
        } else o.ratio = o._ease.getRatio(t / h);
        if (o._time !== l || i) {
            if (!o._initted) {
                if (o._init(), !o._initted || o._gc) return;
                if (!i && o._firstPT && (!1 !== o.vars.lazy && o._duration || o.vars.lazy && !o._duration)) return o._time = o._totalTime = l, o._rawPrevTime = u, I.push(o), void(o._lazy = [t, e]);
            ...
            o._onUpdate && (0 > t && o._startAt && -1e-4 !== t && o._startAt.render(t, !0, i), e || (o._time !== l || r || i) && o._callback("onUpdate")), n && (!o._gc || i) && (0 > t && o._startAt && !o._onUpdate && -1e-4 !== t && o._startAt.render(t, !0, i), r && (o._timeline.autoRemoveChildren && o._enabled(!1, !1), o._active = !1), !e && o.vars[n] && o._callback(n), 0 === h && o._rawPrevTime === _ && a !== _ && (o._rawPrevTime = 0))
        }
        ...
        var t = this._time;
        return this._firstPT = this._overwrittenProps = this._startAt = this._onUpdate = null, this._notifyPluginsOfEnabled = this._active = this._lazy = !1, this._propLookup = this._targets ? {} : [], M.prototype.invalidate.call(this), this.vars.immediateRender && (this._time = -_, this.render(t, !1, !1 !== this.vars.lazy)), this
    }, l._enabled = function (t, e) {
        ...
        if (null == t) return [];
        var i, r, n, s;
        if (t = "string" != typeof t ? t : D.selector(t) || t, (m(t) || X(t)) && "number" != typeof t[0]) {
            for (i = t.length, r = []; --i > -1;) r = r.concat(D.getTweensOf(t[i], e));
            for (i = r.length; --i > -1;)
                for (s = r[i], n = i; --n > -1;) s === r[n] && r.splice(i, 1)
        } else if (t._gsTweenID)
            for (i = (r = tt(t).concat()).length; --i > -1;)(r[i]._gc || e && !r[i].isActive()) && r.splice(i, 1);
        return r || []
    ...
    if (l = nt.prototype, nt.version = "1.19.0", nt.API = 2, l._firstPT = null, l._addTween = V, l.setRatio = Y, l._kill = function (t) {
                        ...
                        var r = function (t) {
                            ...
                            g = function (t) {
                                ...
                                return function (t, h, u) {
                                    var f, p, _, c, d, m, g, v, y, x = (u || e).length,
                                        T = s[x];
                                    if (!T) {
                                        ...
                                        for (T = s[x] = [], f = a ? Math.min(y, x) * l - .5 : r % y, p = a ? x * l / y - .5 : r / y | 0, g = 0, v = 1 / 0, m = 0; x > m; m++) _ = m % y - f, c = p - (m / y | 0), T[m] = d = o ? Math.abs("y" === o ? c : _) : Math.sqrt(_ * _ + c * c), d > g && (g = d), v > d && (v = d);
                                        T.max = g - v, T.min = v, T.v = x = e.amount || e.each * (y > x ? x - 1 : o ? "y" === o ? x / y : y : Math.max(y, x / y)) || 0, T.b = 0 > x ? n - x : n
                                    }
                                    return x = (T[t] - T.min) / T.max, T.b + (i ? i.getRatio(x) : x) * T.v
                                }
                            },
                            v = r.prototype = new e;
                        return r.version = "2.1.3", r.distribute = g, v.constructor = r, v.kill()._gc = v._forcingPlayhead = v._hasPause = !1, v.to = function (t, e, r, n) {
                                ...
                                return n = m(this, n, r), e ? this.add(a.fromTo(t, e, r, n), s) : this.set(t, n, s)
                                ...
                                var f, c, m = new r({
                                    ...
                                    y = n.startAt,
                                    x = n.cycle;
                                for ("string" == typeof t && (t = i.selector(t) || t), o(t = t || []) && (t = d(t)), c = 0; c < t.length; c++) f = p(n), y && (f.startAt = p(y), y.cycle && _(f.startAt, t, c)), x && (_(f, t, c), null != f.duration && (e = f.duration, delete f.duration)), m.to(t[c], e, f, v(c, t[c], t));
                                return this.add(m, a)
                            }, v.staggerFrom = function (t, e, i, r, n, s, a, o) {
                                return i.runBackwards = !0, this.staggerTo(t, e, m(this, i), r, n, s, a, o)
                            }, v.staggerFromTo = function (t, e, i, r, n, s, a, o, l) {
                                return r.startAt = i, this.staggerTo(t, e, m(this, r, i), n, s, a, o, l)
                                ...
                                if ("number" != typeof s && (s = d._parseTimeOrLabel(s, 0, !0, n)), !(n instanceof t)) {
                                    if (n instanceof Array || n && n.push && l(n)) {
                                        for (a = a || "normal", o = o || 0, h = s, u = n.length, f = 0; u > f; f++) l(p = n[f]) && (p = new r({
                                            tweens: p
                                        })), d.add(p, h), "string" != typeof p && "function" != typeof p && ("sequence" === a ? h = p._startTime + p.totalDuration() / p._timeScale : "start" === a && (p._startTime -= p.delay())), h += o;
                                        return d._uncache(!0)
                                    }
                                ...
                                if (e.prototype.add.call(d, n, s), (n._time || !n._duration && n._initted) && (h = (d.rawTime() - n._startTime) * n._timeScale, (!n._duration || Math.abs(Math.max(0, Math.min(n.totalDuration(), h))) - n._totalTime > 1e-5) && n.render(h, !1, !1)),
(d._gc || d._time === d._duration) && !d._paused && d._duration < d.duration()) for (c = (_ = d).rawTime() > n._startTime; _._timeline;) c && _._timeline.smoothChildTiming ? _.totalTime(_._totalTime, !0) : _._gc && _._enabled(!0, !1), _ = _._timeline;
return d
}, v.remove = function (e) {
if (e instanceof t) {
this._remove(e, !1);
...
var r, s, a, o, l, f, p, _, c = this,
d = c._time,
m = c._dirty ? c.totalDuration() : c._totalDuration,
g = c._startTime,
v = c._timeScale,
y = c._paused;
if (d !== c._time && (t += c._time - d), c._hasPause && !c._forcingPlayhead && !e) {
if (t > d)
    for (r = c._first; r && r._startTime <= t && !f;) r._duration || "isPause" !== r.data || r.ratio || 0 === r._startTime && 0 === c._rawPrevTime || (f = r), r = r._next;
else
    for (r = c._last; r && r._startTime >= t && !f;) r._duration || "isPause" === r.data && r._rawPrevTime > 0 && (f = r), r = r._prev;
f && (c._time = c._totalTime = t = f._startTime, _ = c._startTime + (c._reversed ? c._duration - t : t) / c._timeScale)
}
if (t >= m - n && t >= 0) c._totalTime = c._time = m, c._reversed || c._hasPausedChild() || (s = !0, o = "onComplete", l = !!c._timeline.autoRemoveChildren, 0 === c._duration && (0 >= t && t >= -n || c._rawPrevTime < 0 || c._rawPrevTime === n) && c._rawPrevTime !== t && c._first && (l = !0, c._rawPrevTime > n && (o = "onReverseComplete"))), c._rawPrevTime = c._duration || !e || t || c._rawPrevTime === t ? t : n, t = m + 1e-4;
else if (n > t)
if (c._totalTime = c._time = 0, t > -n && (t = 0), (0 !== d || 0 === c._duration && c._rawPrevTime !== n && (c._rawPrevTime > 0 || 0 > t && c._rawPrevTime >= 0)) && (o = "onReverseComplete", s = c._reversed), 0 > t) c._active = !1, c._timeline.autoRemoveChildren && c._reversed ? (l = s = !0, o = "onReverseComplete") : c._rawPrevTime >= 0 && c._first && (l = !0), c._rawPrevTime = t;
else {
    if (c._rawPrevTime = c._duration || !e || t || c._rawPrevTime === t ? t : n, 0 === t && s)
        for (r = c._first; r && 0 === r._startTime;) r._duration || (s = !1), r = r._next;
    t = 0, c._initted || (l = !0)
}
else c._totalTime = c._time = c._rawPrevTime = t;
if (c._time !== d && c._first || i || l || f) {
if (c._initted || (c._initted = !0), c._active || !c._paused && c._time !== d && t > 0 && (c._active = !0), 0 === d && c.vars.onStart && (0 === c._time && c._duration || e || c._callback("onStart")), (p = c._time) >= d)
    for (r = c._first; r && (a = r._next, p === c._time && (!c._paused || y));)(r._active || r._startTime <= p && !r._paused && !r._gc) && (f === r && (c.pause(), c._pauseTime = _), r._reversed ? r.render((r._dirty ? r.totalDuration() : r._totalDuration) - (t - r._startTime) * r._timeScale, e, i) : r.render((t - r._startTime) * r._timeScale, e, i)), r = a;
else
    for (r = c._last; r && (a = r._prev, p === c._time && (!c._paused || y));) {
        if (r._active || r._startTime <= d && !r._paused && !r._gc) {
            if (f === r) {
                for (f = r._prev; f && f.endTime() > c._time;) f.render(f._reversed ? f.totalDuration() - (t - f._startTime) * f._timeScale : (t - f._startTime) * f._timeScale, e, i), f = f._prev;
                f = null, c.pause(), c._pauseTime = _
            }
            r._reversed ? r.render((r._dirty ? r.totalDuration() : r._totalDuration) - (t - r._startTime) * r._timeScale, e, i) : r.render((t - r._startTime) * r._timeScale, e, i)
        }
        r = a
    }
c._onUpdate && (e || (h.length && u(), c._callback("onUpdate"))), o && (c._gc || (g === c._startTime || v !== c._timeScale) && (0 === c._time || m >= c.totalDuration()) && (s && (h.length && u(), c._timeline.autoRemoveChildren && c._enabled(!1, !1), c._active = !1), !e && c.vars[o] && c._callback(o)))
}
...
return t && (this._paused || this._repeat && this.time() > 0 && this.totalProgress() < 1) ? this._totalTime % (this._duration + this._repeatDelay) : this._paused ? this._totalTime : (this._timeline.rawTime(t) - this._startTime) * this._timeScale
    ...
    function (t) {
    ...
    }("TimelineLite"), ((_gsScope = "undefined" != typeof module && module.exports && "undefined" != typeof global ? global : this || window)._gsQueue || (_gsScope._gsQueue = [])).push(function () {
        "use strict";
        _gsScope._gsDefine("easing.Back", ["easing.Ease"], function (t) {
            ...
            return g.constructor = m, g.getRatio = function (t) {
                ...
                for (var i, r, n, s, a, o, l = (e = e || {}).taper || "none", h = [], u = 0, f = 0 | (e.points || 20), p = f, c = !1 !== e.randomize, d = !0 === e.clamp, m = e.template instanceof t ? e.template : null, g = "number" == typeof e.strength ? .4 * e.strength : .4; --p > -1;) i = c ? Math.random() : 1 / f * p, r = m ? m.getRatio(i) : i, "none" === l ? n = g : "out" === l ? n = (s = 1 - i) * s * g : "in" === l ? n = i * i * g : .5 > i ? n = (s = 2 * i) * s * .5 * g : n = (s = 2 * (1 - i)) * s * .5 * g, c ? r += Math.random() * n - .5 * n : p % 2 ? r += .5 * n : r -= .5 * n, d && (r > 1 ? r = 1 : 0 > r && (r = 0)), h[u++] = {
                    x: i,
                    y: r
                };
                for (h.sort(function (t, e) {
                        return t.x - e.x
                    }), o = new _(1, 1, null), p = f; --p > -1;) a = h[p], o = new _(a.x, a.y, o);
                ...
                return new r(t)
            }, r.ease = new r, p("Bounce", u("BounceOut", function (t) {
            ...
            }, !0), f(s.SlowMo, "SlowMo", "ease,"), f(r, "RoughEase", "ease,"), f(e, "SteppedEase", "ease,"), d
        }, !0)
    }), _gsScope._gsDefine && _gsScope._gsQueue.pop()(),
    function () {
        "use strict";
        ...
        "undefined" != typeof module && module.exports ? (require("../TweenLite.min.js"), module.exports = t()) : "function" == typeof define && define.amd && define(["TweenLite"], t)
            ...
            _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function (t, e) {
                        ...
                        var u, f, p, _, c, d, m, g, v = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
                            ...
                            W = function () {
                                var t = G.indexOf("Android"),
                                    e = j("a");
                                return p = -1 !== G.indexOf("Safari") && -1 === G.indexOf("Chrome") && (-1 === t || parseFloat(G.substr(t + 8, 2)) > 3), c = p && parseFloat(G.substr(G.indexOf("Version/") + 8, 2)) < 6, _ = -1 !== G.indexOf("Firefox"), (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(G) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(G)) && (d = parseFloat(RegExp.$1)), !!e && (e.style.cssText = "top:1px;opacity:.55;", /^0.55/.test(e.style.opacity))
                            }(),
                            Z = function (t) {
                            ...
                            K = function (t, e) {
                                ...
                                return r >= 0 ? ($ = 3 === r ? "ms" : i[r], H = "-" + $.toLowerCase() + "-", $ + t) : null
                            },
                            ...
                            et = a.getStyle = function (t, e, i, r, n) {
                                var s;
                                return W || "opacity" !== e ? (!r && t.style[e] ? s = t.style[e] : (i = i || tt(t)) ? s = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(C, "-$1").toLowerCase()) : t.currentStyle && (s = t.currentStyle[e]), null == n || s && "none" !== s && "auto" !== s && "auto auto" !== s ? s : n) : Z(t)
                            },
                            it = q.convertToPixels = function (t, i, r, n, s) {
                                if ("px" === n || !n && "lineHeight" !== i) return r;
                                if ("auto" === n || !r) return 0;
                                var o, l, h, u = F.test(i),
                                    f = t,
                                    p = V.style,
                                    _ = 0 > r,
                                    c = 1 === r;
                                if (_ && (r = -r), c && (r *= 100), "lineHeight" !== i || n)
                                    if ("%" === n && -1 !== i.indexOf("border")) o = r / 100 * (u ? t.clientWidth : t.clientHeight);
                                    else {
                                        if (p.cssText = "border:0 solid red;position:" + et(t, "position") + ";line-height:0;", "%" !== n && f.appendChild && "v" !== n.charAt(0) && "rem" !== n) p[u ? "borderLeftWidth" : "borderTopWidth"] = r + n;
                                        else {
                                            if (f = t.parentNode || B.body, -1 !== et(f, "display").indexOf("flex") && (p.position = "absolute"), l = f._gsCache, h = e.ticker.frame, l && u && l.time === h) return l.width * r / 100;
                                            p[u ? "width" : "height"] = r + n
                                        }
                                        f.appendChild(V), o = parseFloat(V[u ? "offsetWidth" : "offsetHeight"]), f.removeChild(V), u && "%" === n && !1 !== a.cacheWidths && ((l = f._gsCache = f._gsCache || {}).time = h, l.width = o / r * 100), 0 !== o || s || (o = it(t, i, r, n, !0))
                                    }
                                else l = tt(t).lineHeight, t.style.lineHeight = r, o = parseFloat(tt(t).lineHeight), t.style.lineHeight = l;
                                return c && (o /= 100), _ ? -o : o
                            },
                            ...
                            nt = function (t, e) {
                                ...
                                if (e = e || tt(t, null))
                                    if (i = e.length)
                                        for (; --i > -1;)(-1 === (n = e[i]).indexOf("-transform") || Rt === n) && (s[n.replace(A, R)] = e.getPropertyValue(n));
                                    else
                                        for (i in e)(-1 === i.indexOf("Transform") || Mt === i) && (s[i] = e[i]);
                                else if (e = t.currentStyle || t.style)
                                    for (i in e) "string" == typeof i && void 0 === s[i] && (s[i.replace(A, R)] = e[i]);
                                return W || (s.opacity = Z(t)), r = qt(t, e, !1), s.rotation = r.rotation, s.skewX = r.skewX, s.scaleX = r.scaleX, s.scaleY = r.scaleY, s.x = r.x, s.y = r.y, Dt && (s.z = r.z, s.rotationX = r.rotationX, s.rotationY = r.rotationY, s.scaleZ = r.scaleZ), s.filters && delete s.filters, s
                            },
                            st = function (t, e, i, r, n) {
                                var s, a, o, l = {},
                                    h = t.style;
                                for (a in i) "cssText" !== a && "length" !== a && isNaN(a) && (e[a] !== (s = i[a]) || n && n[a]) && -1 === a.indexOf("Origin") && ("number" == typeof s || "string" == typeof s) && (l[a] = "auto" !== s || "left" !== a && "top" !== a ? "" !== s && "auto" !== s && "none" !== s || "string" != typeof e[a] || "" === e[a].replace(w, "") ? s : 0 : rt(t, a), void 0 !== h[a] && (o = new xt(h, a, h[a], o)));
                                if (r)
                            ...
                            lt = function (t, e, i) {
                                ...
                                var r = parseFloat("width" === e ? t.offsetWidth : t.offsetHeight),
                                    n = at[e],
                                    s = n.length;
                                for (i = i || tt(t, null); --s > -1;) r -= parseFloat(et(t, "padding" + n[s], i, !0)) || 0, r -= parseFloat(et(t, "border" + n[s] + "Width", i, !0)) || 0;
                                return r
                            },
                            ht = function (t, e) {
                            ...
                            pt = function (t, e, i, r) {
                                ...
                                return "function" == typeof t && (t = t(g, m)), null == t ? o = e : "number" == typeof t ? o = t : (n = 360, s = t.split("_"), a = ((l = "=" === t.charAt(1)) ? parseInt(t.charAt(0) + "1", 10) * parseFloat(s[0].substr(2)) : parseFloat(s[0])) * (-1 === t.indexOf("rad") ? 1 : L) - (l ? 0 : e), s.length && (r && (r[i] = e + a), -1 !== t.indexOf("short") && ((a %= n) !== a % 180 && (a = 0 > a ? a + n : a - n)), -1 !== t.indexOf("_cw") && 0 > a ? a = (a + 9999999999 * n) % n - (a / n | 0) * n : -1 !== t.indexOf("ccw") && a > 0 && (a = (a - 9999999999 * n) % n - (a / n | 0) * n)), o = e + a), h > o && o > -h && (o = 0), o
                            },
                            _t = {
                                aqua: [0, 255, 255],
                                lime: [0, 255, 0],
                                ...
                                if (t)
                                    if ("number" == typeof t) i = [t >> 16, t >> 8 & 255, 255 & t];
                                        ...
                                        if ("," === t.charAt(t.length - 1) && (t = t.substr(0, t.length - 1)), _t[t]) i = _t[t];
                                            ...
                                            } else a = Number(i[0]) % 360 / 360, o = Number(i[1]) / 100, r = 2 * (l = Number(i[2]) / 100) - (n = .5 >= l ? l * (o + 1) : l + o - l * o), i.length > 3 && (i[3] = Number(i[3])), i[0] = ct(a + 1 / 3, r, n), i[1] = ct(a, r, n), i[2] = ct(a - 1 / 3, r, n);
                                        else i = t.match(v) || _t.transparent;
                                        i[0] = Number(i[0]), i[1] = Number(i[1]), i[2] = Number(i[2]), i.length > 3 && (i[3] = Number(i[3]))
                                    }
                                else i = _t.black;
                                return e && !p && (r = i[0] / 255, n = i[1] / 255, s = i[2] / 255, l = ((h = Math.max(r, n, s)) + (u = Math.min(r, n, s))) / 2, h === u ? a = o = 0 : (f = h - u, o = l > .5 ? f / (2 - h - u) : f / (h + u), a = h === r ? (n - s) / f + (s > n ? 6 : 0) : h === n ? (s - r) / f + 2 : (r - n) / f + 4, a *= 60), i[0] = a + .5 | 0, i[1] = 100 * o + .5 | 0, i[2] = 100 * l + .5 | 0), i
                            },
                            mt = function (t, e) {
                        ...
                        var vt = function (t, e, i, r) {
                                ...
                                return u ? n = e ? function (t) {
                                    ...
                                    if ("number" == typeof t) t += f;
                                        ...
                                        for (c = t.replace(z, "|").split("|"), _ = 0; _ < c.length; _++) c[_] = n(c[_]);
                                        return c.join(",")
                                    }
                                    if (e = (t.match(gt) || [s])[0], _ = (p = t.split(e).join("").match(x) || []).length, u > _--)
                                        for (; ++_ < u;) p[_] = i ? p[(_ - 1) / 2 | 0] : a[_];
                                    return o + p.join(h) + h + e + l + (-1 !== t.indexOf("inset") ? " inset" : "")
                                } : function (t) {
                                    var e, s, p;
                                    if ("number" == typeof t) t += f;
                                    else if (r && z.test(t)) {
                                        for (s = t.replace(z, "|").split("|"), p = 0; p < s.length; p++) s[p] = n(s[p]);
                                        return s.join(",")
                                    }
                                    if (p = (e = t.match("," === h ? x : T) || []).length, u > p--)
                            ...
                            Tt = (q._parseToProxy = function (t, e, i, r, n, s) {
                                var a, o, l, h, u, f = r,
                                    ...
                                    c = i._transform,
                                    d = N;
                                for (i._transform = null, N = e, r = u = i.parse(t, e, r, n), N = d, s && (i._transform = c, f && (f._prev = null, f._prev && (f._prev._next = null))); r && r !== f;) {
                                    if (r.type <= 1 && (_[o = r.p] = r.s + r.c, p[o] = r.s, s || (h = new xt(r, "s", o, h, r.r), r.c = 0), 1 === r.type))
                                        for (a = r.l; --a > 0;) l = "xn" + a, _[o = r.p + "_" + l] = r.data[l], p[o] = r[l], s || (h = new xt(r, l, o, h, r.rxp[l]));
                                    r = r._next
                                }
                                return {
                                    proxy: p,
                                ...
                                this.t = t, this.p = e, this.s = r, this.c = n, this.n = l || e, t instanceof Tt || s.push(this.n), this.r = h ? "function" == typeof h ? h : Math.round : h, this.type = o || 0, u && (this.pr = u, i = !0), this.b = void 0 === f ? r : f, this.e = void 0 === p ? r + n : p, a && (this._next = a, a._prev = this)
                            }),
                            ...
                            bt = a.parseComplex = function (t, e, i, r, n, s, o, l, h, f) {
                                i = i || s || "", "function" == typeof r && (r = r(g, m)), o = new Tt(t, e, 0, 0, o, f ? 2 : 1, null, !1, l, i, r), r += "", n && gt.test(r + i) && (r = [i, r], a.colorStringFilter(r), i = r[0], r = r[1]);
                                var p, _, c, d, x, T, w, b, P, O, S, k, C, A = i.split(", ").join(",").split(" "),
                                    M = r.split(", ").join(",").split(" "),
                                    R = A.length,
                                    F = !1 !== u;
                                for ((-1 !== r.indexOf(",") || -1 !== i.indexOf(",")) && (-1 !== (r + i).indexOf("rgb") || -1 !== (r + i).indexOf("hsl") ? (A = A.join(" ").replace(z, ", ").split(" "), M = M.join(" ").replace(z, ", ").split(" ")) : (A = A.join(" ").split(",").join(", ").split(" "), M = M.join(" ").split(",").join(", ").split(" ")), R = A.length), R !== M.length && (R = (A = (s || "").split(" ")).length), o.plugin = h, o.setRatio = f, gt.lastIndex = 0, p = 0; R > p; p++)
                                    if (d = A[p], x = M[p] + "", (b = parseFloat(d)) || 0 === b) o.appendXtra("", b, ut(x, b), x.replace(y, ""), !(!F || -1 === x.indexOf("px")) && Math.round, !0);
                                    else if (n && gt.test(d)) k = ")" + ((k = x.indexOf(")") + 1) ? x.substr(k) : ""), C = -1 !== x.indexOf("hsl") && W, O = x, d = dt(d, C), x = dt(x, C), (P = d.length + x.length > 6) && !W && 0 === x[3] ? (o["xs" + o.l] += o.l ? " transparent" : "transparent", o.e = o.e.split(M[p]).join("transparent")) : (W || (P = !1), C ? o.appendXtra(O.substr(0, O.indexOf("hsl")) + (P ? "hsla(" : "hsl("), d[0], ut(x[0], d[0]), ",", !1, !0).appendXtra("", d[1], ut(x[1], d[1]), "%,", !1).appendXtra("", d[2], ut(x[2], d[2]), P ? "%," : "%" + k, !1) : o.appendXtra(O.substr(0, O.indexOf("rgb")) + (P ? "rgba(" : "rgb("), d[0], x[0] - d[0], ",", Math.round, !0).appendXtra("", d[1], x[1] - d[1], ",", Math.round).appendXtra("", d[2], x[2] - d[2], P ? "," : k, Math.round), P && (d = d.length < 4 ? 1 : d[3], o.appendXtra("", d, (x.length < 4 ? 1 : x[3]) - d, k, !1))), gt.lastIndex = 0;
                                else if (T = d.match(v)) {
                                    if (!(w = x.match(y)) || w.length !== T.length) return o;
                                    for (c = 0, _ = 0; _ < T.length; _++) S = T[_], O = d.indexOf(S, c), o.appendXtra(d.substr(c, O - c), Number(S), ut(w[_], S), "", !(!F || "px" !== d.substr(O + S.length, 2)) && Math.round, 0 === _), c = O + S.length;
                                    o["xs" + o.l] += d.substr(c)
                                } else o["xs" + o.l] += o.l || o["xs" + o.l] ? " " + x : x;
                                if (-1 !== r.indexOf("=") && o.data) {
                                    for (k = o.xs0 + o.data.s, p = 1; p < o.l; p++) k += o["xs" + p] + o.data["xn" + p];
                                    o.e = k + o["xs" + p]
                                }
                                return o.l || (o.type = -1, o.xs0 = o.e), o.xfirst || o
                            },
                            Pt = 9;
                        for ((h = Tt.prototype).l = h.pr = 0; --Pt > 0;) h["xn" + Pt] = 0, h["xs" + Pt] = "";
                        h.xs0 = "", h._next = h._prev = h.xfirst = h.data = h.plugin = h.setRatio = h.rxp = null, h.appendXtra = function (t, e, i, r, n, s) {
                            var a = this,
                                o = a.l;
                            return a["xs" + o] += s && (o || a["xs" + o]) ? " " + t : t || "", i || 0 === o || a.plugin ? (a.l++, a.type = a.setRatio ? 2 : 1, a["xs" + a.l] = r || "", o > 0 ? (a.data["xn" + o] = e + i, a.rxp["xn" + o] = n, a["xn" + o] = e, a.plugin || (a.xfirst = new Tt(a, "xn" + o, e, i, a.xfirst || a, 0, a.n, n, a.pr), a.xfirst.xs0 = 0), a) : (a.data = {
                                s: e + i
                            }, a.rxp = {}, a.s = e, a.c = i, a.r = n, a)) : (a["xs" + o] += e + (r || ""), a)
                        };
                        var Ot = function (t, e) {
                                e = e || {}, this.p = e.prefix && K(t) || t, l[t] = l[this.p] = this, this.format = e.formatter || vt(e.defaultValue, e.color, e.collapsible, e.multi), e.parser && (this.parse = e.parser), this.clrs = e.color, this.multi = e.multi, this.keyword = e.keyword, this.dflt = e.defaultValue, this.allowFunc = e.allowFunc, this.pr = e.priority || 0
                            },
                            St = q._registerComplexSpecialProp = function (t, e, i) {
                                ...
                                var r, n, s = t.split(","),
                                    a = e.defaultValue;
                                for (i = i || [a], r = 0; r < s.length; r++) e.prefix = 0 === r && e.prefix, e.defaultValue = i[r] || a, n = new Ot(s[r], e)
                            },
                                ...
                                if (!l[t]) {
                                    ...
                                    St(t, {
                                        parser: function (t, i, r, n, s, a, h) {
                                            ...
                                            return u ? (u._cssRegister(), l[r].parse(t, i, r, n, s, a, h)) : (Q("Error: " + e + " js file not loaded."), s)
                                        }
                                    })
                                }
                            };
                        (h = Ot.prototype).parseComplex = function (t, e, i, r, n, s) {
                            ...
                            if (this.multi && (z.test(i) || z.test(e) ? (o = e.replace(z, "|").split("|"), l = i.replace(z, "|").split("|")) : p && (o = [e], l = [i])), l) {
                                for (h = l.length > o.length ? l.length : o.length, a = 0; h > a; a++) e = o[a] = o[a] || this.dflt, i = l[a] = l[a] || this.dflt, p && ((u = e.indexOf(p)) !== (f = i.indexOf(p)) && (-1 === f ? o[a] = o[a].split(p).join("") : -1 === u && (o[a] += " " + p)));
                                e = o.join(", "), i = l.join(", ")
                            }
                        ...
                        var Ct, At = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                            ...
                            Lt = function () {
                                ...
                                return B.createElementNS && Et.appendChild && !r && (t = It("svg", Et), i = (e = It("rect", t, {
                                    width: 100,
                                    height: 50,
                                    x: 100
                                })).getBoundingClientRect().width, e.style[Ft] = "50% 50%", e.style[Mt] = "scaleX(0.5)", r = i === e.getBoundingClientRect().width && !(_ && Dt), Et.removeChild(t)), r
                            }(),
                            Nt = function (t, e, i, r, n, s) {
                                var o, l, h, u, f, p, _, c, d, m, g, v, y, x, T = t._gsTransform,
                                    w = Ut(t, !0);
                                T && (y = T.xOrigin, x = T.yOrigin), (!r || (o = r.split(" ")).length < 2) && (0 === (_ = t.getBBox()).x && 0 === _.y && _.width + _.height === 0 && (_ = {
                                        ...
                                        width: 0,
                                        height: 0
                                    }), o = [(-1 !== (e = ht(e).split(" "))[0].indexOf("%") ? parseFloat(e[0]) / 100 * _.width : parseFloat(e[0])) + _.x, (-1 !== e[1].indexOf("%") ? parseFloat(e[1]) / 100 * _.height : parseFloat(e[1])) + _.y]), i.xOrigin = u = parseFloat(o[0]), i.yOrigin = f = parseFloat(o[1]), r && w !== Vt && (p = w[0], _ = w[1], c = w[2], d = w[3], m = w[4], g = w[5], (v = p * d - _ * c) && (l = u * (d / v) + f * (-c / v) + (c * g - d * m) / v, h = u * (-_ / v) + f * (p / v) - (p * g - _ * m) / v,
u = i.xOrigin = o[0] = l, f = i.yOrigin = o[1] = h)), T && (s && (i.xOffset = T.xOffset, i.yOffset = T.yOffset, T = i), n || !1 !== n && !1 !== a.defaultSmoothOrigin ? (l = u - y, h = f - x, T.xOffset += l * w[0] + h * w[2] - l, T.yOffset += l * w[1] + h * w[3] - h) : T.xOffset = T.yOffset = 0), s || t.setAttribute("data-svg-origin", o.join(" "))
}, Yt = function (t) {
    ...
    var i, r, n, s, a, o, l, h = t._gsTransform || new Xt,
        u = 1e5,
        f = t.style;
    if (Mt ? r = et(t, Rt, null, !0) : t.currentStyle && (r = (r = t.currentStyle.filter.match(D)) && 4 === r.length ? [r[0].substr(4), Number(r[2].substr(4)), Number(r[1].substr(4)), r[3].substr(4), h.x || 0, h.y || 0].join(",") : ""), i = !r || "none" === r || "matrix(1, 0, 0, 1, 0, 0)" === r, Mt && i && !t.offsetParent && t !== Et && (s = f.display, f.display = "block", (l = t.parentNode) && t.offsetParent || (a = 1, o = t.nextSibling, Et.appendChild(t)), i = !(r = et(t, Rt, null, !0)) || "none" === r || "matrix(1, 0, 0, 1, 0, 0)" === r, s ? f.display = s : Qt(f, "display"), a && (o ? l.insertBefore(t, o) : l ? l.appendChild(t) : Et.removeChild(t))), (h.svg || t.getCTM && jt(t)) && (i && -1 !== (f[Mt] + "").indexOf("matrix") && (r = f[Mt], i = 0), n = t.getAttribute("transform"), i && n && (r = "matrix(" + (n = t.transform.baseVal.consolidate().matrix).a + "," + n.b + "," + n.c + "," + n.d + "," + n.e + "," + n.f + ")", i = 0)), i) return Vt;
    for (n = (r || "").match(v) || [], Pt = n.length; --Pt > -1;) s = Number(n[Pt]), n[Pt] = (a = s - (s |= 0)) ? (a * u + (0 > a ? -.5 : .5) | 0) / u + s : s;
    return e && n.length > 6 ? [n[0], n[1], n[4], n[5], n[12], n[13]] : n
}, qt = q.getTransform = function (t, i, r, n) {
    if (t._gsTransform && r && !n) return t._gsTransform;
    var s, o, l, h, u, f, p = r && t._gsTransform || new Xt,
        _ = p.scaleX < 0,
        c = 2e-5,
        d = 1e5,
        m = Dt && (parseFloat(et(t, Ft, i, !1, "0 0 0").split(" ")[2]) || p.zOrigin) || 0,
        g = parseFloat(a.defaultTransformPerspective) || 0;
    if (p.svg = !(!t.getCTM || !jt(t)), p.svg && (Nt(t, et(t, Ft, i, !1, "50% 50%") + "", p, t.getAttribute("data-svg-origin")), Ct = a.useSVGTransformAttr || Lt), (s = Ut(t)) !== Vt) {
        if (16 === s.length) {
            var v, y, x, T, w, b = s[0],
                P = s[1],
                O = s[2],
                ...
                E = s[11],
                N = Math.atan2(A, D);
            p.zOrigin && (X = R * (I = -p.zOrigin) - s[12], z = F * I - s[13], I = D * I + p.zOrigin - s[14]), p.rotationX = N * L, N && (v = k * (T = Math.cos(-N)) + R * (w = Math.sin(-N)), y = C * T + F * w, x = A * T + D * w, R = k * -w + R * T, F = C * -w + F * T, D = A * -w + D * T, E = M * -w + E * T, k = v, C = y, A = x), N = Math.atan2(-O, D), p.rotationY = N * L, N && (y = P * (T = Math.cos(-N)) - F * (w = Math.sin(-N)), x = O * T - D * w, F = P * w + F * T, D = O * w + D * T, E = S * w + E * T, b = v = b * T - R * w, P = y, O = x), N = Math.atan2(P, b), p.rotation = N * L, N && (v = b * (T = Math.cos(N)) + P * (w = Math.sin(N)), y = k * T + C * w, x = R * T + F * w, P = P * T - b * w, C = C * T - k * w, F = F * T - R * w, b = v, k = y, R = x), p.rotationX && Math.abs(p.rotationX) + Math.abs(p.rotation) > 359.9 && (p.rotationX = p.rotation = 0, p.rotationY = 180 - p.rotationY), N = Math.atan2(k, C), p.scaleX = (Math.sqrt(b * b + P * P + O * O) * d + .5 | 0) / d, p.scaleY = (Math.sqrt(C * C + A * A) * d + .5 | 0) / d, p.scaleZ = (Math.sqrt(R * R + F * F + D * D) * d + .5 | 0) / d, b /= p.scaleX, k /= p.scaleY, P /= p.scaleX, C /= p.scaleY, Math.abs(N) > c ? (p.skewX = N * L, k = 0, "simple" !== p.skewType && (p.scaleY *= 1 / Math.cos(N))) : p.skewX = 0, p.perspective = E ? 1 / (0 > E ? -E : E) : 0, p.x = X, p.y = z, p.z = I, p.svg && (p.x -= p.xOrigin - (p.xOrigin * b - p.yOrigin * k), p.y -= p.yOrigin - (p.yOrigin * P - p.xOrigin * C))
            ...
            var Y = s.length >= 6,
                ...
                V = s[2] || 0,
                U = Y ? s[3] : 1;
            p.x = s[4] || 0, p.y = s[5] || 0, l = Math.sqrt(B * B + j * j), h = Math.sqrt(U * U + V * V), u = B || j ? Math.atan2(j, B) * L : p.rotation || 0, f = V || U ? Math.atan2(V, U) * L + u : p.skewX || 0, p.scaleX = l, p.scaleY = h, p.rotation = u, p.skewX = f, Dt && (p.rotationX = p.rotationY = p.z = 0, p.perspective = g, p.scaleZ = 1), p.svg && (p.x -= p.xOrigin - (p.xOrigin * B + p.yOrigin * V), p.y -= p.yOrigin - (p.xOrigin * j + p.yOrigin * U))
        }
        for (o in Math.abs(p.skewX) > 90 && Math.abs(p.skewX) < 270 && (_ ? (p.scaleX *= -1, p.skewX += p.rotation <= 0 ? 180 : -180, p.rotation += p.rotation <= 0 ? 180 : -180) : (p.scaleY *= -1, p.skewX += p.skewX <= 0 ? 180 : -180)), p.zOrigin = m, p) p[o] < c && p[o] > -c && (p[o] = 0)
    }
    return r && (t._gsTransform = p, p.svg && (Ct && t.style[Mt] ? e.delayedCall(.001, function () {
        Qt(t.style, Mt)
    ...
    if (p) {
        ...
        if (null != r.ox && (x += (_ = (r.oxp ? m * r.ox * .01 : r.ox) - m / 2) - (_ * o + (c = (r.oyp ? g * r.oy * .01 : r.oy) - g / 2) * l), T += c - (_ * h + c * u)), v ? y += ", Dx=" + ((_ = m / 2) - (_ * o + (c = g / 2) * l) + x) + ", Dy=" + (c - (_ * h + c * u) + T) + ")" : y += ", sizingMethod='auto expand')", -1 !== e.indexOf("DXImageTransform.Microsoft.Matrix(") ? f.filter = e.replace(X, y) : f.filter = y + " " + e, (0 === t || 1 === t) && 1 === o && 0 === l && 0 === h && 1 === u && (v && -1 === y.indexOf("Dx=0, Dy=0") || P.test(e) && 100 !== parseFloat(RegExp.$1) || -1 === e.indexOf(e.indexOf("Alpha")) && f.removeAttribute("filter")), !v) {
            var w, O, S, k = 8 > d ? 1 : -1;
            for (_ = r.ieOffsetX || 0, c = r.ieOffsetY || 0, r.ieOffsetX = Math.round((m - ((0 > o ? -o : o) * m + (0 > l ? -l : l) * g)) / 2 + x), r.ieOffsetY = Math.round((g - ((0 > u ? -u : u) * g + (0 > h ? -h : h) * m)) / 2 + T), Pt = 0; 4 > Pt; Pt++) S = (i = -1 !== (w = p[O = ot[Pt]]).indexOf("px") ? parseFloat(w) : it(this.t, O, parseFloat(w), w.replace(b, "")) || 0) !== r[O] ? 2 > Pt ? -r.ieOffsetX : -r.ieOffsetY : 2 > Pt ? _ - r.ieOffsetX : c - r.ieOffsetY, f[O] = (r[O] = Math.round(i - S * (0 === Pt || 2 === Pt ? 1 : k))) + "px"
        }
    }
}, Wt = q.set3DTransformRatio = q.setTransformRatio = function (t) {
    var e, i, r, n, s, a, o, l, h, u, f, p, c, d, m, g, v, y, x, T, w, b, P, O = this.data,
        S = this.t.style,
        k = O.rotation,
        C = O.rotationX,
        A = O.rotationY,
        ...
        Y = O.skewY,
        B = O.skewX;
    if (Y && (B += Y, k += Y), !((1 !== t && 0 !== t || "auto" !== N || this.tween._totalTime !== this.tween._totalDuration && this.tween._totalTime) && N || z || L || A || C || 1 !== F) || Ct && I || !Dt) k || B || I ? (k *= E, b = B * E, P = 1e5, i = Math.cos(k) * M, s = Math.sin(k) * M, r = Math.sin(k - b) * -R, a = Math.cos(k - b) * R, b && "simple" === O.skewType && (e = Math.tan(b - Y * E), r *= e = Math.sqrt(1 + e * e), a *= e, Y && (e = Math.tan(Y * E), i *= e = Math.sqrt(1 + e * e), s *= e)), I && (D += O.xOrigin - (O.xOrigin * i + O.yOrigin * r) + O.xOffset, X += O.yOrigin - (O.xOrigin * s + O.yOrigin * a) + O.yOffset, Ct && (O.xPercent || O.yPercent) && (m = this.t.getBBox(), D += .01 * O.xPercent * m.width, X += .01 * O.yPercent * m.height), (m = 1e-6) > D && D > -m && (D = 0), m > X && X > -m && (X = 0)), x = (i * P | 0) / P + "," + (s * P | 0) / P + "," + (r * P | 0) / P + "," + (a * P | 0) / P + "," + D + "," + X + ")", I && Ct ? this.t.setAttribute("transform", "matrix(" + x) : S[Mt] = (O.xPercent || O.yPercent ? "translate(" + O.xPercent + "%," + O.yPercent + "%) matrix(" : "matrix(") + x) : S[Mt] = (O.xPercent || O.yPercent ? "translate(" + O.xPercent + "%," + O.yPercent + "%) matrix(" : "matrix(") + M + ",0,0," + R + "," + D + "," + X + ")";
    else {
        if (_ && ((m = 1e-4) > M && M > -m && (M = F = 2e-5), m > R && R > -m && (R = F = 2e-5), !L || O.z || O.rotationX || O.rotationY || (L = 0)), k || B) k *= E, g = i = Math.cos(k), v = s = Math.sin(k), B && (k -= B * E, g = Math.cos(k), v = Math.sin(k), "simple" === O.skewType && (e = Math.tan((B - Y) * E), g *= e = Math.sqrt(1 + e * e), v *= e, O.skewY && (e = Math.tan(Y * E), i *= e = Math.sqrt(1 + e * e), s *= e))), r = -v, a = g;
        else {
            if (!(A || C || 1 !== F || L || I)) return void(S[Mt] = (O.xPercent || O.yPercent ? "translate(" + O.xPercent + "%," + O.yPercent + "%) translate3d(" : "translate3d(") + D + "px," + X + "px," + z + "px)" + (1 !== M || 1 !== R ? " scale(" + M + "," + R + ")" : ""));
            i = a = 1, r = s = 0
        }
        u = 1, n = o = l = h = f = p = 0, c = L ? -1 / L : 0, d = O.zOrigin, m = 1e-6, T = ",", w = "0", (k = A * E) && (g = Math.cos(k), l = -(v = Math.sin(k)), f = c * -v, n = i * v, o = s * v, u = g, c *= g, i *= g, s *= g), (k = C * E) && (e = r * (g = Math.cos(k)) + n * (v = Math.sin(k)), y = a * g + o * v, h = u * v, p = c * v, n = r * -v + n * g, o = a * -v + o * g, u *= g, c *= g, r = e, a = y), 1 !== F && (n *= F, o *= F, u *= F, c *= F), 1 !== R && (r *= R, a *= R, h *= R, p *= R), 1 !== M && (i *= M, s *= M, l *= M, f *= M), (d || I) && (d && (D += n * -d, X += o * -d, z += u * -d + d), I && (D += O.xOrigin - (O.xOrigin * i + O.yOrigin * r) + O.xOffset, X += O.yOrigin - (O.xOrigin * s + O.yOrigin * a) + O.yOffset), m > D && D > -m && (D = w), m > X && X > -m && (X = w), m > z && z > -m && (z = 0)), x = O.xPercent || O.yPercent ? "translate(" + O.xPercent + "%," + O.yPercent + "%) matrix3d(" : "matrix3d(", x += (m > i && i > -m ? w : i) + T + (m > s && s > -m ? w : s) + T + (m > l && l > -m ? w : l), x += T + (m > f && f > -m ? w : f) + T + (m > r && r > -m ? w : r) + T + (m > a && a > -m ? w : a), C || A || 1 !== F ? (x += T + (m > h && h > -m ? w : h) + T + (m > p && p > -m ? w : p) + T + (m > n && n > -m ? w : n), x += T + (m > o && o > -m ? w : o) + T + (m > u && u > -m ? w : u) + T + (m > c && c > -m ? w : c) + T) : x += ",0,0,0,0,1,0,", x += D + T + X + T + z + T + (L ? 1 + -z / L : 1) + ")", S[Mt] = x
    }
};
(h = Xt.prototype).x = h.y = h.z = h.skewX = h.skewY = h.rotation = h.rotationX = h.rotationY = h.zOrigin = h.xPercent = h.yPercent = h.xOffset = h.yOffset = 0, h.scaleX = h.scaleY = h.scaleZ = 1, St("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
    parser: function (t, e, i, r, s, o, l) {
        if (r._lastParsedTransform === l) return s;
        r._lastParsedTransform = l;
        var h = l.scale && "function" == typeof l.scale ? l.scale : 0;
        h && (l.scale = h(g, t));
        var u, f, p, _, c, d, v, y, x, T = t._gsTransform,
            w = t.style,
            b = 1e-6,
            P = At.length,
            O = l,
            S = {},
            k = "transformOrigin",
            C = qt(t, n, !0, O.parseTransform),
            A = O.transform && ("function" == typeof O.transform ? O.transform(g, m) : O.transform);
        if (C.skewType = O.skewType || C.skewType || a.defaultSkewType, r._transform = C, "rotationZ" in O && (O.rotation = O.rotationZ), A && "string" == typeof A && Mt)(f = V.style)[Mt] = A, f.display = "block", f.position = "absolute", -1 !== A.indexOf("%") && (f.width = et(t, "width"), f.height = et(t, "height")), B.body.appendChild(V), u = qt(V, null, !1), "simple" === C.skewType && (u.scaleY *= Math.cos(u.skewX * E)), C.svg && (d = C.xOrigin, v = C.yOrigin, u.x -= C.xOffset, u.y -= C.yOffset, (O.transformOrigin || O.svgOrigin) && (A = {}, Nt(t, ht(O.transformOrigin), A, O.svgOrigin, O.smoothOrigin, !0), d = A.xOrigin, v = A.yOrigin, u.x -= A.xOffset - C.xOffset, u.y -= A.yOffset - C.yOffset), (d || v) && (y = Ut(V, !0), u.x -= d - (d * y[0] + v * y[2]), u.y -= v - (d * y[1] + v * y[3]))), B.body.removeChild(V), u.perspective || (u.perspective = C.perspective), null != O.xPercent && (u.xPercent = ft(O.xPercent, C.xPercent)), null != O.yPercent && (u.yPercent = ft(O.yPercent, C.yPercent));
            ...
            "string" == typeof O.x && -1 !== O.x.indexOf("%") && (u.x = 0, u.xPercent = ft(O.x, C.xPercent)), "string" == typeof O.y && -1 !== O.y.indexOf("%") && (u.y = 0, u.yPercent = ft(O.y, C.yPercent)), u.rotation = pt("rotation" in O ? O.rotation : "shortRotation" in O ? O.shortRotation + "_short" : C.rotation, C.rotation, "rotation", S), Dt && (u.rotationX = pt("rotationX" in O ? O.rotationX : "shortRotationX" in O ? O.shortRotationX + "_short" : C.rotationX || 0, C.rotationX, "rotationX", S), u.rotationY = pt("rotationY" in O ? O.rotationY : "shortRotationY" in O ? O.shortRotationY + "_short" : C.rotationY || 0, C.rotationY, "rotationY", S)), u.skewX = pt(O.skewX, C.skewX), u.skewY = pt(O.skewY, C.skewY)
        }
        for (Dt && null != O.force3D && (C.force3D = O.force3D, _ = !0), (p = C.force3D || C.z || C.rotationX || C.rotationY || u.z || u.rotationX || u.rotationY || u.perspective) || null == O.scale || (u.scaleZ = 1); --P > -1;)((A = u[x = At[P]] - C[x]) > b || -b > A || null != O[x] || null != N[x]) && (_ = !0, s = new Tt(C, x, C[x], A, s), x in S && (s.e = S[x]), s.xs0 = 0, s.plugin = o, r._overwriteProps.push(s.n));
        return A = "function" == typeof O.transformOrigin ? O.transformOrigin(g, m) : O.transformOrigin, C.svg && (A || O.svgOrigin) && (d = C.xOffset, v = C.yOffset, Nt(t, ht(A), u, O.svgOrigin, O.smoothOrigin), s = wt(C, "xOrigin", (T ? C : u).xOrigin, u.xOrigin, s, k), s = wt(C, "yOrigin", (T ? C : u).yOrigin, u.yOrigin, s, k), (d !== C.xOffset || v !== C.yOffset) && (s = wt(C, "xOffset", T ? d : C.xOffset, C.xOffset, s, k), s = wt(C, "yOffset", T ? v : C.yOffset, C.yOffset, s, k)), A = "0px 0px"), (A || Dt && p && C.zOrigin) && (Mt ? (_ = !0, x = Ft, A || (A = (A = (et(t, x, n, !1, "50% 50%") + "").split(" "))[0] + " " + A[1] + " " + C.zOrigin + "px"), A += "", (s = new Tt(w, x, 0, 0, s, -1, k)).b = w[x], s.plugin = o, Dt ? (f = C.zOrigin, A = A.split(" "), C.zOrigin = (A.length > 2 ? parseFloat(A[2]) : f) || 0, s.xs0 = s.e = A[0] + " " + (A[1] || "50%") + " 0px", (s = new Tt(C, "zOrigin", 0, 0, s, -1, s.n)).b = f, s.xs0 = s.e = C.zOrigin) : s.xs0 = s.e = A) : ht(A + "", C)), _ && (r._transformType = C.svg && Ct || !p && 3 !== this._transformType ? 2 : 3), h && (l.scale = h), s
    },
    allowFunc: !0,
    prefix: !0
}), St("boxShadow", {
    ...
    parser: function (t, e, i, s, a, o) {
        e = this.format(e);
        var l, h, u, f, p, _, c, d, m, g, v, y, x, T, w, b, P = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"],
            O = t.style;
        for (m = parseFloat(t.offsetWidth), g = parseFloat(t.offsetHeight), l = e.split(" "), h = 0; h < P.length; h++) this.p.indexOf("border") && (P[h] = K(P[h])), -1 !== (p = f = et(t, P[h], n, !1, "0px")).indexOf(" ") && (f = p.split(" "), p = f[0], f = f[1]), _ = u = l[h], c = parseFloat(p), y = p.substr((c + "").length), (x = "=" === _.charAt(1)) ? (d = parseInt(_.charAt(0) + "1", 10), _ = _.substr(2), d *= parseFloat(_), v = _.substr((d + "").length - (0 > d ? 1 : 0)) || "") : (d = parseFloat(_), v = _.substr((d + "").length)), "" === v && (v = r[i] || y), v !== y && (T = it(t, "borderLeft", c, y), w = it(t, "borderTop", c, y), "%" === v ? (p = T / m * 100 + "%", f = w / g * 100 + "%") : "em" === v ? (p = T / (b = it(t, "borderLeft", 1, "em")) + "em", f = w / b + "em") : (p = T + "px", f = w + "px"), x && (_ = parseFloat(p) + d + v, u = parseFloat(f) + d + v)), a = bt(O, P[h], p + " " + f, _ + " " + u, !1, "0px", a);
        return a
    },
    prefix: !0,
    ...
    parser: function (t, e, i, r, s, a) {
        ...
        if (-1 !== m.indexOf("%") != (-1 !== g.indexOf("%")) && g.split(",").length < 2 && ((p = et(t, "backgroundImage").replace(M, "")) && "none" !== p)) {
            for (o = m.split(" "), l = g.split(" "), U.setAttribute("src", p), h = 2; --h > -1;)(u = -1 !== (m = o[h]).indexOf("%")) !== (-1 !== l[h].indexOf("%")) && (f = 0 === h ? t.offsetWidth - U.width : t.offsetHeight - U.height, o[h] = u ? parseFloat(m) / 100 * f + "px" : parseFloat(m) / f * 100 + "%");
            m = o.join(" ")
        }
...
var Zt = function (t) {
    var e, i = this.t,
        ...
        n = this.s + this.c * t | 0;
    100 === n && (-1 === r.indexOf("atrix(") && -1 === r.indexOf("radient(") && -1 === r.indexOf("oader(") ? (i.removeAttribute("filter"), e = !et(this.data, "filter")) : (i.filter = r.replace(S, ""), e = !0)), e || (this.xn1 && (i.filter = r = r || "alpha(opacity=" + n + ")"), -1 === r.indexOf("pacity") ? 0 === n && this.xn1 || (i.filter = r + " alpha(opacity=" + n + ")") : i.filter = r.replace(P, "opacity=" + n))
};
St("opacity,alpha,autoAlpha", {
    ...
    parser: function (t, e, i, r, s, a) {
        var o = parseFloat(et(t, "opacity", n, !1, "1")),
            l = t.style,
            h = "autoAlpha" === i;
        return "string" == typeof e && "=" === e.charAt(1) && (e = ("-" === e.charAt(0) ? -1 : 1) * parseFloat(e.substr(2)) + o), h && 1 === o && "hidden" === et(t, "visibility", n) && 0 !== e && (o = 0), W ? s = new Tt(l, "opacity", o, e - o, s) : ((s = new Tt(l, "opacity", 100 * o, 100 * (e - o), s)).xn1 = h ? 1 : 0, l.zoom = 1, s.type = 2, s.b = "alpha(opacity=" + s.s + ")", s.e = "alpha(opacity=" + (s.s + s.c) + ")", s.data = t, s.plugin = a, s.setRatio = Zt), h && ((s = new Tt(l, "visibility", 0, 0, s, -1, null, !1, 0, 0 !== o ? "inherit" : "hidden", 0 === e ? "hidden" : "inherit")).xs0 = "inherit", r._overwriteProps.push(s.n), r._overwriteProps.push(i)), s
    }
});
var Qt = function (t, e) {
...
St("className", {
    parser: function (t, e, r, s, a, o, l) {
        var h, u, f, p, _, c = t.getAttribute("class") || "",
            d = t.style.cssText;
        if ((a = s._classNamePT = new Tt(t, r, 0, 0, a, 2)).setRatio = Ht, a.pr = -11, i = !0, a.b = c, u = nt(t, n), f = t._gsClassPT) {
            for (p = {}, _ = f.data; _;) p[_.p] = 1, _ = _._next;
            f.setRatio(1)
        }
        return t._gsClassPT = a, a.e = "=" !== e.charAt(1) ? e : c.replace(new RegExp("(?:\\s|^)" + e.substr(2) + "(?![\\w-])"), "") + ("+" === e.charAt(0) ? " " + e.substr(2) : ""), t.setAttribute("class", a.e), h = st(t, u, nt(t), l, p), t.setAttribute("class", c), a.data = h.firstMPT, t.style.cssText !== d && (t.style.cssText = d), a = a.xfirst = s.parse(t, h.difs, a, o)
    }
});
var $t = function (t) {
    if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
        ...
        if ("all" === this.e) a.cssText = "", n = !0;
            ...
            for (r = (e = this.e.split(" ").join("").split(",")).length; --r > -1;) i = e[r], l[i] && (l[i].parse === o ? n = !0 : i = "transformOrigin" === i ? Ft : l[i].p), Qt(a, i);
        n && (Qt(a, Mt), (s = this.t._gsTransform) && (s.svg && (this.t.removeAttribute("data-svg-origin"), this.t.removeAttribute("transform")), delete this.t._gsTransform))
    }
};
for (St("clearProps", {
        parser: function (t, e, r, n, s) {
            return (s = new Tt(t, r, 0, 0, s, 2)).setRatio = $t, s.e = e, s.pr = -10, s.data = n._tween, i = !0, s
        }
...
(h = a.prototype)._firstPT = h._lastParsedTransform = h._transform = null, h._onInitTween = function (t, e, o, h) {
    ...
    this._target = m = t, this._tween = o, this._vars = e, g = h, u = e.autoRound, i = !1, r = e.suffixMap || a.suffixMap, n = tt(t, ""), s = this._overwriteProps;
    var _, d, v, y, x, T, w, b, P, S = t.style;
    if (f && "" === S.zIndex && (("auto" === (_ = et(t, "zIndex", n)) || "" === _) && this._addLazySet(S, "zIndex", 0)), "string" == typeof e && (y = S.cssText, _ = nt(t, n), S.cssText = y + ";" + e, _ = st(t, _, nt(t)).difs, !W && O.test(e) && (_.opacity = parseFloat(RegExp.$1)), e = _, S.cssText = y), e.className ? this._firstPT = d = l.className.parse(t, e.className, "className", this, null, null, e) : this._firstPT = d = this.parse(t, e, null), this._transformType) {
        for (P = 3 === this._transformType, Mt ? p && (f = !0, "" === S.zIndex && (("auto" === (w = et(t, "zIndex", n)) || "" === w) && this._addLazySet(S, "zIndex", 0)), c && this._addLazySet(S, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (P ? "visible" : "hidden"))) : S.zoom = 1, v = d; v && v._next;) v = v._next;
        b = new Tt(t, "transform", 0, 0, null, 2), this._linkCSSP(b, null, v), b.setRatio = Mt ? Wt : Gt, b.data = this._transform || qt(t, n, !0), b.tween = o, b.pr = -1, s.pop()
    }
    if (i) {
        for (; d;) {
    ...
    for (a in e) {
        if (_ = e[a], o = l[a], "function" != typeof _ || o && o.allowFunc || (_ = _(g, m)), o) i = o.parse(t, _, a, this, i, s, e);
        else {
            if ("--" === a.substr(0, 2)) {
                this._tween._propLookup[a] = this._addTween.call(this._tween, t.style, "setProperty", tt(t).getPropertyValue(a) + "", _ + "", a, !1, a);
                continue
            }
            p = et(t, a, n) + "", v = "string" == typeof _, "color" === a || "fill" === a || "stroke" === a || -1 !== a.indexOf("Color") || v && k.test(_) ? (v || (_ = ((_ = dt(_)).length > 3 ? "rgba(" : "rgb(") + _.join(",") + ")"), i = bt(x, a, p, _, !0, "transparent", i, 0, s)) : v && I.test(_) ? i = bt(x, a, p, _, !0, null, i, 0, s) : (c = (h = parseFloat(p)) || 0 === h ? p.substr((h + "").length) : "", ("" === p || "auto" === p) && ("width" === a || "height" === a ? (h = lt(t, a, n), c = "px") : "left" === a || "top" === a ? (h = rt(t, a, n), c = "px") : (h = "opacity" !== a ? 0 : 1, c = "")), (y = v && "=" === _.charAt(1)) ? (f = parseInt(_.charAt(0) + "1", 10), _ = _.substr(2), f *= parseFloat(_), d = _.replace(b, "")) : (f = parseFloat(_), d = v ? _.replace(b, "") : ""), "" === d && (d = a in r ? r[a] : c), _ = f || 0 === f ? (y ? f + h : f) + d : e[a], c !== d && ("" !== d || "lineHeight" === a) && (f || 0 === f) && h && (h = it(t, a, h, c), "%" === d ? (h /= it(t, a, 100, "%") / 100, !0 !== e.strictUnits && (p = h + "%")) : "em" === d || "rem" === d || "vw" === d || "vh" === d ? h /= it(t, a, 1, d) : "px" !== d && (f = it(t, a, f, d), d = "px"), y && (f || 0 === f) && (_ = f + h + d)), y && (f += h), !h && 0 !== h || !f && 0 !== f ? void 0 !== x[a] && (_ || _ + "" != "NaN" && null != _) ? (i = new Tt(x, a, f || h || 0, 0, i, -1, a, !1, 0, p, _)).xs0 = "none" !== _ || "display" !== a && -1 === a.indexOf("Style") ? _ : p : Q("invalid " + a + " tween value: " + e[a]) : (i = new Tt(x, a, h, f - h, i, 0, a, !1 !== u && ("px" === d || "zIndex" === a), 0, p, _)).xs0 = d)
        }
    ...
    this._transform = this._transform || qt(this._target, n, !0), this._transformType = this._transform.svg && Ct || !t && 3 !== this._transformType ? 2 : 3
};
var Kt = function (t) {
...
var Jt = function (t, e, i) {
    ...
    if (t.slice)
        ...
        for (n = (r = t.childNodes).length; --n > -1;) a = (s = r[n]).type, s.style && (e.push(nt(s)), i && i.push(s)), 1 !== a && 9 !== a && 11 !== a || !s.childNodes.length || Jt(s, e, i)
};
...
for (t = l._targets || l.target, Jt(t, u, p), l.render(i, !0, !0), Jt(t, f), l.render(0, !0, !0), l._enabled(!0), n = p.length; --n > -1;)
...
! function e(t, r) {
    ...
    return function (e) {
        ...
        }, t.p = "", t(t.s = "./src/wavesurfer.js")
    }({
        "./node_modules/debounce/index.js": function (e, t) {
            function r(e, t, r) {
                function n() {
                    var l = Date.now() - o;
                    l < t && l >= 0 ? i = setTimeout(n, t - l) : (i = null, r || (u = e.apply(s, a), s = a = null))
                }
                var i, a, s, o, u;
                null == t && (t = 100);
                var l = function () {
                    ...
                    var l = r && !i;
                    return i || (i = setTimeout(n, t)), l && (u = e.apply(s, a), s = a = null), u
                };
                return l.clear = function () {
                    i && (clearTimeout(i), i = null)
                }, l.flush = function () {
                    i && (u = e.apply(s, a), s = a = null, clearTimeout(i), i = null)
                }, l
            }
        ...
        "./src/drawer.js": function (e, t, r) {
            ...
            var d = n(r("./src/util/index.js")),
                p = function (e) {
                    function t(e, r) {
                        var n;
                        return a(this, t), (n = u(this, c(t).call(this))).container = e, n.params = r, n.width = 0, n.height = r.height * n.params.pixelRatio, n.lastPos = 0, n.wrapper = null, n
                    }
                    return f(t, e), o(t, [{
                        key: "style",
                        ...
                        value: function e(t, r) {
                            ...
                            var n = t.targetTouches ? t.targetTouches[0].clientX : t.clientX,
                                ...
                                s = this.getWidth(),
                                o;
                            return !this.params.fillParent && a < s ? (o = (this.params.rtl ? i.right - n : n - i.left) * (this.params.pixelRatio / a) || 0) > 1 && (o = 1) : o = ((this.params.rtl ? i.right - n : n - i.left) + this.wrapper.scrollLeft) / this.wrapper.scrollWidth || 0, o
                        }
                    }, {
                        ...
                        value: function e() {
                            ...
                            this.wrapper.addEventListener("click", function (e) {
                                ...
                                if (0 != r) {
                                    ...
                                    if (e.clientY >= n.bottom - r) return
                                }
                        ...
                        value: function e(t, r, n, i) {
                            this.setWidth(r) || this.clearWave(), this.params.barWidth ? this.drawBars(t, 0, n, i) : this.drawWave(t, 0, n, i)
                        }
                    }, {
                        key: "resetScroll",
                        value: function e() {
                        ...
                        value: function e() {
                            ...
                            if (this.wrapper) {
                                ...
                                if (t = Math.round(this.wrapper.scrollLeft * r), this.params.scrollParent) {
        ...
        "./src/drawer.multicanvas.js": function (e, t, r) {
            ...
            var p = i(r("./src/drawer.js")),
                ...
                y = function (e) {
                    function t(e, r) {
                        var n;
                        return s(this, t), (n = l(this, f(t).call(this, e, r))).maxCanvasWidth = r.maxCanvasWidth, n.maxCanvasElementWidth = Math.round(r.maxCanvasWidth / r.pixelRatio), n.hasProgressCanvas = r.waveColor != r.progressColor, n.halfPixel = .5 / r.pixelRatio, n.canvases = [], n.progressWave = null, n
                    }
                    return h(t, e), u(t, [{
                        key: "init",
                        value: function e() {
                        ...
                        key: "updateSize",
                        value: function e() {
                            for (var t = this, r = Math.round(this.width / this.params.pixelRatio), n = Math.ceil(r / (this.maxCanvasElementWidth + 2)); this.canvases.length < n;) this.addCanvas();
                            ...
                            this.canvases.forEach(function (e, r) {
                                ...
                                r == t.canvases.length - 1 && (n = t.width - t.maxCanvasWidth * (t.canvases.length - 1)), t.updateDimensions(e, n, t.height), t.clearWaveForEntry(e)
                            })
                        }
                    }, {
                        key: "addCanvas",
                        ...
                        value: function e(t, r, n) {
                            ...
                            t.start = t.waveCtx.canvas.offsetLeft / a || 0, t.end = t.start + i / a, t.waveCtx.canvas.width = r, t.waveCtx.canvas.height = n, this.style(t.waveCtx.canvas, {
                                width: i + "px"
                            }), this.style(this.progressWave, {
                                display: "block"
                            }), this.hasProgressCanvas && (t.progressCtx.canvas.width = r, t.progressCtx.canvas.height = n, this.style(t.progressCtx.canvas, {
                                width: i + "px"
                            }))
                        }
                    }, {
                            ...
                            return this.prepareDraw(t, r, n, i, function (e) {
                                ...
                                if (void 0 !== n) {
                                    var c = r ? 2 : 1,
                                        ...
                                        d, p = h + (null === a.params.barGap ? Math.max(a.params.pixelRatio, ~~(h / 2)) : Math.max(a.params.pixelRatio, a.params.barGap * a.params.pixelRatio)),
                                        v = f / a.width,
                                        y, m = i,
                                        b;
                                    for (b = n; b < m; b += p) {
                            ...
                            return this.prepareDraw(t, r, n, i, function (e) {
                                ...
                                if (!r) {
                                    var c = [],
                                        f = l.length,
                                        h;
                                    for (h = 0; h < f; h++) c[2 * h] = l[h], c[2 * h + 1] = -l[h];
                                    l = c
                                }
                                void 0 !== n && a.drawLine(l, t, u, o, n, i), a.fillRect(0, u + o - a.halfPixel, a.width, a.halfPixel)
                            })
                        }
                    }, {
                        key: "drawLine",
                        ...
                        value: function e(t, r, n, i, a, s, o, u) {
                            if (r) {
                                var l = n.length / 2,
                                    ...
                                    p, v, y = t.progress.width / (d - h - 1),
                                    m = a + s,
                                    b = i / a;
                                for (r.beginPath(), r.moveTo((h - c) * y, m), r.lineTo((h - c) * y, m - Math.round((n[2 * h] || 0) / b)), p = h; p < d; p++) {
                                    var g = n[2 * p] || 0,
                                        k = Math.round(g / b);
                                ...
                                r.lineTo((h - c) * y, m - Math.round((n[2 * h + 1] || 0) / b)), r.closePath(), r.fill()
                            }
                        }
                    }, {
                        key: "fillRect",
                        value: function e(t, r, n, i) {
                            var a = Math.floor(t / this.maxCanvasWidth),
                            ...
                            for (o = a; o < s; o++) {
                                ...
                                c.x1 < c.x2 && (this.setFillStyles(u), this.fillRectToContext(u.waveCtx, c.x1 - l, c.y1, c.x2 - c.x1, c.y2 - c.y1), this.fillRectToContext(u.progressCtx, c.x1 - l, c.y1, c.x2 - c.x1, c.y2 - c.y1))
                            }
                        }
                    }, {
                        key: "prepareDraw",
                        value: function e(t, r, n, i, a) {
                            ...
                            return v.frame(function () {
                                if (t[0] instanceof Array) {
                                    var e = t;
                                    if (s.params.splitChannels) return s.setHeight(e.length * s.params.height * s.params.pixelRatio), e.forEach(function (e, t) {
        ...
        "./src/mediaelement.js": function (e, t, r) {
            ...
            var y = i(r("./src/webaudio.js")),
                ...
                b = function (e) {
                    function t(e) {
                        var r;
                        return s(this, t), (r = l(this, d(t).call(this, e))).params = e, r.media = {
                            currentTime: 0,
                            duration: 0,
                            paused: !0,
                            playbackRate: 1,
                    ...
                    return p(t, e), u(t, [{
                        ...
                        value: function e() {
                            ...
                            this.on("play", r), this.on("pause", function () {
                        ...
                        value: function e(t, r, n, i) {
                            ...
                            a.controls = this.params.mediaControls, a.autoplay = this.params.autoplay || !1, a.preload = null == i ? "auto" : i, a.src = t, a.style.width = "100%";
                            var s = r.querySelector(this.mediaType);
                            s && r.removeChild(s), r.appendChild(a), this._load(a, n)
                        }
                    }, {
                        key: "loadElt",
                        value: function e(t, r) {
                            t.controls = this.params.mediaControls, t.autoplay = this.params.autoplay || !1, this._load(t, r)
                        }
                    }, {
                        key: "_load",
                        value: function e(t, r) {
                            ...
                            "function" == typeof t.load && t.load(), t.addEventListener("error", function () {
                                ...
                                n.fireEvent("pause")
                            }), this.media = t, this.peaks = r, this.onPlayEnd = null, this.buffer = null, this.setPlaybackRate(this.playbackRate), this.setVolume(this.volume)
                        }
                    }, {
                        key: "isPaused",
                        value: function e() {
            ...
            var s = function () {
                ...
                return a(e, [{
                    ...
                    value: function e(t, r, n) {
                        ...
                        for (var i = [], a = 0; a < this.peakCacheRanges.length && this.peakCacheRanges[a] < r;) a++;
                        for (a % 2 == 0 && i.push(r); a < this.peakCacheRanges.length && this.peakCacheRanges[a] <= n;) i.push(this.peakCacheRanges[a]), a++;
                        a % 2 == 0 && i.push(n), i = i.filter(function (e, t, r) {
                    ...
                    value: function e() {
                        var t = [],
                            r;
                        for (r = 0; r < this.peakCacheRanges.length; r += 2) t.push([this.peakCacheRanges[r], this.peakCacheRanges[r + 1]]);
                        return t
                    }
                }]), e
            }();
            ...
            var s = function () {
                ...
                return a(e, [{
                    ...
                    value: function e(t, r) {
                        ...
                        return i || (i = this.handlers[t] = []), i.push(r), {
                            name: t,
                            callback: r,
                            un: function e(t, r) {
                                return n.un(t, r)
                    ...
                    value: function e(t, r) {
                        if (this.handlers) {
                            ...
                            if (n)
                                if (r)
                                    for (i = n.length - 1; i >= 0; i--) n[i] == r && n.splice(i, 1);
                                else n.length = 0
                        }
                    }
                }, {
                    ...
                    value: function e(t, r) {
                        var n = this,
                            i = function e() {
                                ...
                                r.apply(n, a), setTimeout(function () {
                                    n.un(t, e)
                                }, 0)
                            };
                        return this.on(t, i)
        ...
        "./src/wavesurfer.js": function (e, t, r) {
            ...
            var p = i(r("./src/util/index.js")),
                ...
                k = function (e) {
                    function t(e) {
                        var r;
                        if (f(this, t), (r = s(this, o(t).call(this))).defaultParams = {
                                audioContext: null,
                                ...
                                WebAudio: y.default
                            }, r.util = p, r.params = p.extend({}, r.defaultParams, e), r.container = "string" == typeof e.container ? document.querySelector(r.params.container) : r.params.container, !r.container) throw new Error("Container element not found");
                        ...
                        }, "number" == typeof r.params.responsive ? r.params.responsive : 100), s(r, u(r))
                    }
                    return l(t, e), d(t, null, [{
                        key: "create",
                        value: function e(r) {
                            var n;
                            return new t(r).init()
                        ...
                        value: function e(t) {
                            ...
                            n = Math.max(0, Math.min(r, n + (t || 0))), this.seekAndCenter(n / r)
                        }
                    }, {
                        key: "seekAndCenter",
                        value: function e(t) {
                        ...
                        value: function e(t) {
                            var r = this;
                            if ("number" != typeof t || !isFinite(t) || t < 0 || t > 1) return console.error("Error calling wavesurfer.seekTo, parameter must be a number between 0 and 1!");
                        ...
                        key: "setMute",
                        value: function e(t) {
                            t !== this.isMuted ? (t ? (this.savedVolume = this.backend.getVolume(), this.backend.setVolume(0), this.isMuted = !0, this.fireEvent("volume", 0)) : (this.backend.setVolume(this.savedVolume), this.isMuted = !1, this.fireEvent("volume", this.savedVolume)), this.fireEvent("mute", this.isMuted)) : this.fireEvent("mute", this.isMuted)
                        }
                    }, {
                        key: "getMute",
                        value: function e() {
                        ...
                        value: function e(t) {
                            this.params.backgroundColor = t, p.style(this.container, {
                        ...
                        value: function e() {
                            ...
                            if (this.params.fillParent && (!this.params.scrollParent || t < r) && (i = 0, a = n = r), this.params.partialRender) {
                                var o = this.peakCache.addRangeToPeakCache(n, i, a),
                                    u;
                                for (u = 0; u < o.length; u++) s = this.backend.getPeaks(n, o[u][0], o[u][1]), this.drawer.drawPeaks(s, n, o[u][0], o[u][1])
                        ...
                        key: "zoom",
                        value: function e(t) {
                            t ? (this.params.minPxPerSec = t, this.params.scrollParent = !0) : (this.params.minPxPerSec = this.defaultParams.minPxPerSec, this.params.scrollParent = !1), this.drawBuffer(), this.drawer.progress(this.backend.getPlayedPercents()), this.drawer.recenter(this.getCurrentTime() / this.getDuration()), this.fireEvent("zoom", t)
                        }
                    }, {
                        key: "loadArrayBuffer",
                        value: function e(t) {
                        ...
                        value: function e(t, r, n) {
                            var i = this,
                                a = function e(r) {
                                    return r && i.tmpEvents.push(i.once("ready", r)), i.getArrayBuffer(t, function (e) {
                                        return i.loadArrayBuffer(e)
                                    })
                                };
                            if (!r) return a();
                            this.backend.setPeaks(r, n), this.drawBuffer(), this.tmpEvents.push(this.once("interaction", a))
                        }
                    }, {
                        ...
                        value: function e(t, r, n, i) {
                            var a = this,
                                s = t;
                            if ("string" == typeof t) this.backend.load(s, this.mediaContainer, r, n);
                            else {
                                var o = t;
                                this.backend.loadElt(o, r), s = o.src
                            }
                            this.tmpEvents.push(this.backend.once("canplay", function () {
                                a.drawBuffer(), a.fireEvent("ready"), a.isReady = !0
                            }), this.backend.once("error", function (e) {
                                return a.fireEvent("error", e)
                            })), r && this.backend.setPeaks(r, i), r && !this.params.forceDecode || !this.backend.supportsWebAudio() || this.getArrayBuffer(s, function (e) {
                        ...
                        value: function e(t) {
                            var r;
                            r = t.lengthComputable ? t.loaded / t.total : t.loaded / (t.loaded + 1e6), this.fireEvent("loading", Math.round(100 * r), t.target)
                        }
                    }, {
                        key: "exportPCM",
                        value: function e(t, r, n, i) {
                            t = t || 1024, i = i || 0, r = r || 1e4, n = n || !1;
                        ...
                        key: "exportImage",
                        value: function e(t, r) {
                            return t || (t = "image/png"), r || (r = 1), this.drawer.getImage(t, r)
                        }
                    }, {
                        key: "cancelAjax",
                        value: function e() {
            ...
            t.default = k, k.VERSION = "2.2.1", k.util = p, e.exports = t.default
        },
        "./src/webaudio.js": function (e, t, r) {
            ...
            var p = n(r("./src/util/index.js")),
                ...
                b = function (e) {
                    function t(e) {
                        var r, n, i;
                        return s(this, t), (i = o(this, l(t).call(this))).audioContext = null, i.offlineAudioContext = null, i.stateBehaviors = (a(r = {}, v, {
                            init: function e() {
                        ...
                        }), r), i.params = e, i.ac = e.audioContext || i.getAudioContext(), i.lastPlay = i.ac.currentTime, i.startPosition = 0, i.scheduledPause = null, i.states = (a(n = {}, v, Object.create(i.stateBehaviors[v])), a(n, y, Object.create(i.stateBehaviors[y])), a(n, m, Object.create(i.stateBehaviors[m])), n), i.analyser = null, i.buffer = null, i.filters = [], i.gainNode = null, i.mergedPeaks = null, i.offlineAc = null, i.peaks = null, i.playbackRate = 1, i.analyser = null, i.scriptNode = null, i.source = null, i.splitPeaks = [], i.state = null, i.explicitDuration = e.duration, i
                    }
                    return h(t, e), f(t, [{
                        ...
                        key: "init",
                        value: function e() {
                            this.createVolumeNode(), this.createScriptNode(), this.createAnalyserNode(), this.setState(y), this.setPlaybackRate(this.params.audioRate), this.setLength(0)
                        }
                    }, {
                        ...
                        key: "setFilters",
                        value: function e(t) {
                            this.disconnectFilters(), t && t.length && (this.filters = t, this.analyser.disconnect(), t.reduce(function (e, t) {
                        ...
                        value: function e() {
                            ...
                            this.scriptNode.onaudioprocess = function () {
                                ...
                                e >= t.getDuration() ? (t.setState(m), t.fireEvent("pause")) : e >= t.scheduledPause ? t.pause() : t.state === t.states[v] && t.fireEvent("audioprocess", e)
                            }
                        }
                    }, {
                        ...
                        value: function e(t) {
                            if (t) {
                                ...
                                if (!r.setSinkId) return Promise.reject(new Error("setSinkId is not supported in your browser"));
                                r.autoplay = !0;
                                var n = this.ac.createMediaStreamDestination();
                                return this.gainNode.disconnect(), this.gainNode.connect(n), r.srcObject = n.stream, r.setSinkId(t)
                            }
                        ...
                        key: "decodeArrayBuffer",
                        value: function e(t, r, n) {
                            this.offlineAc || (this.offlineAc = this.getOfflineAudioContext(this.ac && this.ac.sampleRate ? this.ac.sampleRate : 44100)), this.offlineAc.decodeAudioData(t, function (e) {
                                return r(e)
                            }, n)
                        }
                    }, {
                        key: "setPeaks",
                        value: function e(t, r) {
                            null != r && (this.explicitDuration = r), this.peaks = t
                        }
                    }, {
                        key: "setLength",
                        value: function e(t) {
                            if (!this.mergedPeaks || t != 2 * this.mergedPeaks.length - 1 + 2) {
                                ...
                                var r = this.buffer ? this.buffer.numberOfChannels : 1,
                                    n;
                                for (n = 0; n < r; n++) this.splitPeaks[n] = [], this.splitPeaks[n][2 * (t - 1)] = 0, this.splitPeaks[n][2 * (t - 1) + 1] = 0;
                        ...
                        value: function e(t, r, n) {
                            ...
                            if (r = r || 0, n = n || t - 1, this.setLength(t), !this.buffer) return this.params.splitChannels ? this.splitPeaks : this.mergedPeaks;
                            if (!this.buffer.length) {
                                var i = this.createBuffer(1, 4096, this.sampleRate);
                                this.buffer = i.buffer
                            }
                            var a = this.buffer.length / t,
                                s = ~~(a / 10) || 1,
                            ...
                            for (u = 0; u < o; u++) {
                                ...
                                for (f = r; f <= n; f++) {
                                    ...
                                    l[2 * f] = v, l[2 * f + 1] = p, (0 == u || v > this.mergedPeaks[2 * f]) && (this.mergedPeaks[2 * f] = v), (0 == u || p < this.mergedPeaks[2 * f + 1]) && (this.mergedPeaks[2 * f + 1] = p)
                                }
                            }
                        ...
                        key: "seekTo",
                        value: function e(t, r) {
                            if (this.buffer) return this.scheduledPause = null, null == t && (t = this.getCurrentTime()) >= this.getDuration() && (t = 0), null == r && (r = this.getDuration()), this.startPosition = t, this.lastPlay = this.ac.currentTime, this.state === this.states[m] && this.setState(y), {
                                start: t,
                                end: r
                            }
                        }
                        ...
                        value: function e(t, r) {
                            if (this.buffer) {
                                ...
                                t = n.start, r = n.end, this.scheduledPause = r, this.source.start(0, t, r - t), "suspended" == this.ac.state && this.ac.resume && this.ac.resume(), this.setState(v), this.fireEvent("play")
                            }
                        }
                    }, {
                        key: "pause",
                        value: function e() {
                            this.scheduledPause = null, this.startPosition += this.getPlayedTime(), this.source && this.source.stop(0), this.setState(y), this.fireEvent("pause")
                        }
                    }, {
                        key: "getCurrentTime",
                        value: function e() {
            ...
            t.default = b, b.scriptBufferSize = 256, e.exports = t.default
        }
    })
});
...
! function (e, a, t) {
    ...
    n.utils.init = function () {
        n.cache.window = $(e), n.cache.document = $(a), n.cache.html = $("html"), n.cache.body = $("body"), n.cache.header = n.cache.body.find("header"), n.cache.wavesurferready = !1, n.cache.wavesurfer, n.cache.filters = [{
            f: 250,
            value: -12,
            type: "peaking"
        }, {
        ...
        $(e).load(function (a) {
            ...
            function s() {}
            t(), a.currentTarget.pageYOffset > 0 && n.utils.position(tl, a.currentTarget.pageYOffset, a), $(e).scroll(function (e) {
                n.utils.position(tl, e.currentTarget.pageYOffset, e)
            }), e.addEventListener("orientationchange", function () {
                e.scroll(0, 0), setTimeout(function () {
                    tl.kill(), t()
                }, 500)
        ...
        var s = t.currentTarget.innerWidth,
            ...
            i = a / (u - o);
        a >= 0 && e.progress(i).pause(), n.cache.wavesurferready && (a > c ? $("#sound-af").hasClass("sound-af-act") || (n.utils.soundeq(n.cache.filtersact), n.cache.wavesurfer.setVolume(.15), $("#sound-af").addClass("sound-af-act")) : $("#sound-af").hasClass("sound-af-act") && (n.utils.soundeq(n.cache.filters), n.cache.wavesurfer.setVolume(.4), $("#sound-af").removeClass("sound-af-act")), a > c + o + o + o ? n.cache.html.addClass("add-mobile-fix") : n.cache.html.removeClass("add-mobile-fix"))
    }, n.utils.sound = function () {
        var e = WaveSurfer.create({
            container: "#sound-af"
        });
        e.on("finish", function () {
            n.cache.wavesurfer.play(), n.cache.wavesurfer.skip(32.9)
        }), e.on("ready", function () {
            e.setVolume(.6), e.play(), n.cache.wavesurfer = e, n.cache.wavesurferready = !0, n.utils.soundeq(n.cache.filters)
            ...
            e.preventDefault(), $(".sound-btn").hasClass("sound-btn-off") ? (n.cache.wavesurfer.play(), $(this).removeClass("sound-btn-off")) : (n.cache.wavesurfer.stop(), $(this).addClass("sound-btn-off"))
        })
    }, n.utils.soundeq = function (e) {
        var a = e.map(function (e) {
            var a = n.cache.wavesurfer.backend.ac.createBiquadFilter();
            return a.type = e.type, a.gain.value = e.value, a.Q.value = 1, a.frequency.value = e.f, a
        });
        n.cache.wavesurfer.backend.setFilters(a)
    }, n.utils.domLoad = function () {
        n.utils.sound(), n.utils.gsap(), $("#play").on("click", function (a) {
            return a.preventDefault(), e.open("https://www.facebook.com/harsha.hacky"), !1
        }), $("#instagram").on("click", function (a) {
            return a.preventDefault(), e.open("https://instagram.com/hacky._.harsha?igshid=1p83dl06jnoks"), !1
        })
    }, n.utils.init(), jQuery(function (e) {
        n.utils.domLoad()
    })
}(window, document);
